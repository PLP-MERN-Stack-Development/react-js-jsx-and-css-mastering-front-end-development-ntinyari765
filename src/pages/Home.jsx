...
export default function Home() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white flex flex-col items-center justify-center text-center px-6">
      <div className="max-w-2xl bg-white/70 backdrop-blur-sm shadow-lg rounded-3xl p-10 border border-blue-100">
        <h1 className="text-4xl font-extrabold text-blue-700 mb-4">
          Welcome to TaskFlow 
        </h1>
        <p className="text-blue-700/80 text-lg leading-relaxed mb-6">
